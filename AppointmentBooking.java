...
class AppointmentBooking
{
	...
	{
		doctorName.add("Akanksha Divya Tigga");
		doctorName.add("Pratima Sonali Horo");
		doctorName.add("Pradeep Yadav");
		doctorName.add("Chandan Mahato");
		doctorName.add("Vivek Jaria");
		doctorName.add("Pragya Gupta");
		doctorName.add("Gourav Tiwari");
		...
		doctorPassword.add("Akanksha123");
		doctorPassword.add("Pratima123");
		doctorPassword.add("Pradeep123");
		doctorPassword.add("Chandan123");
		doctorPassword.add("Vivek123");
		doctorPassword.add("Pragya123");
		doctorPassword.add("Gourav23");
		...
		doctorMobileNumber.add(9422887565);
		doctorMobileNumber.add(1234645543);
		doctorMobileNumber.add(1676767588);
		doctorMobileNumber.add(3438948109);
		doctorMobileNumber.add(3746736839);
		doctorMobileNumber.add(2327328382);
		doctorMobileNumber.add(2312y381y2);
	...
	void doctorRegistration() throws Exception
	{
		...
		boolean flag=true, flag1=true;
			...
			new ProcessBuilder("cmd", "/f", "cls").inheritIO().start().waitFor();
